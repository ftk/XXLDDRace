...
// client
MACRO_CONFIG_INT(ClPredict, cl_predict, 1, 0, 2, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Predict client movements")
...
MACRO_CONFIG_INT(UiMousesens, ui_mousesens, 100, -5000, 100000, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Mouse sensitivity for menus/editor")
...
MACRO_CONFIG_INT(SvInactiveLogoutTime, sv_inactivelogout_time, 0, 0, 1000, CFGFLAG_SERVER, "How many minutes to wait before logging players out of rcon")
MACRO_CONFIG_INT(SvMemberProtection, sv_member_protection, 0, 0, 1, CFGFLAG_SERVER, "Protect logged in members against vote kick")
#endif
